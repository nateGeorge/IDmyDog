...
def do_analysis(i, breed):
    ...
    pk.dump(histNtext, open('../pickle_files/fgHara-full-13x4.pd.pk', 'wb'))
...
pbar = progressbar.ProgressBar(maxval=1459, widgets=widgets).start() # think maxval should be bb.shape[0]*6.3, but know its 1459 post-mortem
